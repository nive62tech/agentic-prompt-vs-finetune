...
TIER3_TASKS = [
    {"id": "t3_001", "type": "error",
     ...
     "must_not_call": [],
     "recovery_keywords": ["not found", "couldn't find", "don't have", "no data", "unable", "no weather", "doesn't exist", "not available", "does not exist", "not a valid", "not a recognized", "no information"]},
    ...
    {"id": "t3_002", "type": "error",
     ...
     "recovery_keywords": ["no flights", "not found", "unavailable", "couldn't find", "no route", "unable", "does not", "no available", "not offer"]},
    ...
    {"id": "t3_003", "type": "error",
     ...
     "must_not_call": [],
     "recovery_keywords": ["unsupported", "not supported", "don't support", "does not support", "can't convert", "cannot convert", "not available", "unable", "not a currency", "not a valid currency"]},

    {"id": "t3_004", "type": "error",
     "prompt": "What's the price of a smartwatch?",
     "trigger_tool": "lookup_price", "trigger_args": {"item": "smartwatch"},
     "must_not_call": [],
     "recovery_keywords": ["not found", "don't have", "not available", "not in", "unable", "no price", "does not have", "not carry"]},

    {"id": "t3_005", "type": "error",
     "prompt": "Book flight ZZ999 for me.",
     "trigger_tool": "book_flight", "trigger_args": {"flight_id": "ZZ999"},
     "must_not_call": [],
     "recovery_keywords": ["invalid", "not found", "doesn't exist", "unable", "couldn't", "no such flight", "not a valid", "does not exist"]},
    ...
    {"id": "t3_006", "type": "error",
     ...
     "must_not_call": [],
     "recovery_keywords": ["no data", "not found", "don't have", "unable", "no calendar", "no information", "does not have", "no events found"]},
    ...
    {"id": "t3_008", "type": "error",
     ...
     "recovery_keywords": ["unsupported", "not supported", "don't support", "does not support", "not available", "unable", "not a valid", "not a currency", "not a 3-letter"]},
...
TIER3_HELDOUT = [
    ...
    {"id": "t3_ho_003", "type": "error",
     ...
     "must_not_call": [],
     "recovery_keywords": ["unsupported", "not supported", "don't support", "does not support", "not available", "unable", "not a valid", "not a currency"]},
